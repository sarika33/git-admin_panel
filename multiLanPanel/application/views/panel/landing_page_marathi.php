		...
		<div id="myCarousel" class="carousel slide" data-ride="carousel">
		    ...
		    <div class="carousel-inner">
		    	...
		    	<label> <?= lang('title'); ?> </label> 
		   			   ...
		   			   <a href="english"><button type="button">Translate</button></a>
			    	<div class= "row timer-circle">
			    		<div class= "main-text text-center">
			    			<h2 class="top-text"><?php echo lang('message');?> </h2>
						...
						<div class= "col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
							<div class= "circle text-center">
								...
								<div class= "row" id= "spacer2">
									<div class= "title"></div>
									<div class= "title" id= "days"> <?php echo lang('message');?> </div>
								</div>
							</div>
							<div class= "circle text-center">
								<div class= "row" id= "spacer1">
		        ...
		        <div class="item active">
					...
					<div class= "carousel-caption caption">
						<h1>Summer sun, shining brightly</h1>
					</div>
		        ...
		        <div class="item">
					...
					<div class= "carousel-caption caption">
						<h1>It is time to feel raindrop</h1>
					</div>
		        ...
		        <div class="item">
					...
					<div class= "carousel-caption caption">
						<h1>Winter begins, Snow in everywhere.</h1>
					</div>        
			...
			<div class="container">
				<div class="row text-center">
					...
					<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 text-center">
						<div class="copyright">
							&copy; Copyright 2017 Quesup Web Solutons Pvt.Ltd.
						</div>
					</div>
