        ...
        <div class="navbar-header">
            ...
            <ul class="nav navbar-top-links navbar-right pull-right">
                <li class="mega-dropdown">
                    <a class="dropdown-toggle waves-effect waves-light" data-toggle="dropdown" ><span class="hidden-xs">Admin</span> <i class="icon-options-vertical"></i></a>
                </li>
            </ul>
        </div>
        ...
        <div class="sidebar-nav navbar-collapse slimscrollsidebar">
            <div class="user-profile">
                <div class="dropdown user-pro-body">
                    <div></div><br>
                    <a href="#" class="dropdown-toggle u-dropdown" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> </a>
           ...
           <!--    <li><a href="user1" class="waves-effect"><i class="linea-icon linea-basic fa-fw" data-icon=")"></i> <span class="hide-menu">Users</span></a></li>
                  ...
                  <li><a href="service1" class="waves-effect"><i class="linea-icon linea-basic fa-fw" data-icon="&#xe00b;"></i> <span class="hide-menu">Services</span></a></li>
                          ...
                          <li><a href="blog1" class="waves-effect"><i class="linea-icon linea-basic fa-fw" data-icon="&#xe008;"></i> <span class="hide-menu">Blogs</span></a></li>
                             <li><a href="contact1" class="waves-effect"><i class="fa fa-folder-open-o" data-icon="&#xe008;"></i> <span class="hide-menu">Contact Details</span></a></li> -->
                              <li><a href="page" class="waves-effect"><i class="linea-icon linea-basic fa-fw" data-icon="&#xe008;"></i> <span class="hide-menu">Page Details</span></a></li>
                             <!--   <li><a href="menu" class="waves-effect"><i class="linea-icon linea-basic fa-fw" data-icon="&#xe008;"></i> <span class="hide-menu">Menu Details</span></a></li>
                           -->
