...
<?php endif; ?>
<div class="container">
  <?php echo form_open_multipart("service",['class'=>'form-horizontal', 'style'=>"border: 1px solid; padding: 10px;  width:50%; margin-left:25%;",'name'=>'registration_form','id'=>'registration_form'])?>
  <fieldset>
    <legend style="text-align: center;">New Service</legend>
  ...
  <div class="col-lg-6">
    <div class="form-group">
      ...
      <div class="col-lg-8">
        ...
        <!--    <input type="text" class="form-control" id="form_status" name="status" placeholder="status" > -->
      </div>
    </div>
  </div>
  <div class="col-lg-6">
