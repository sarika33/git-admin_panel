				...
				success: function(data){
					...
					for(i=0; i<data.length; i++){
						html +='<tr>'+
									...
									'<td>'+
										'<a href="javascript:;" class="btn btn-info btn-rounded item-edit" data="'+data[i].s_id+'">Edit</a>'+
										'<a href="javascript:;" class="btn btn-danger btn-rounded item-delete" data="'+data[i].s_id+'">Delete</a>'+
									'</td>'+
							    '</tr>';
					}
					$('#showdata').html(html);
