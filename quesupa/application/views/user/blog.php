...
<div class="container content-sm">
	...
	<div class="container content-sm">
		...
		<div class="row">
			<div class="col-md-5">
				<img class="img-responsive" src="<?php echo base_url().'./uploads/'.$blog->image ?>" alt="1"/>
				</div>
				 <div class="col-md-7 title-v1 no-margin-bottom" >
					<h2 class="font-light"><a href=""><?php echo $blog->blog_name?></a></h2>
					<p class="no-margin-bottom" style="text-align: justify;"><?php echo $blog->description ?></p>
